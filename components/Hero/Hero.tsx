      ...
      <div className='sub-container'>
        <div className={styles.hero__inner}>
          ...
          <div className={styles.hero__description}>
            <p>
              Напишите мне письмо <br /> и я с удовольствием присоединюсь к проекту!
            </p>
          </div>
          <Link to='contact' spy={true} smooth={true} offset={30} duration={500} className={styles.hero__btn}>
            Связаться с разработчиком
          </Link>
          {!isMobile800 && (
            <Link to='about' spy={true} smooth={true} offset={30} duration={500} className={styles.hero__arrow} />
          )}
        </div>
      </div>
    </section>
