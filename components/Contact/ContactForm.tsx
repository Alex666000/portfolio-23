...
const ContactForm = () => {
  ...
  const sendEmail = (e: FormEvent<HTMLFormElement>) => {
    ...
    setSpinner(true)
    emailjs.sendForm("service_s7oaq88", "template_svw94lk", formRef.current, "GMo-mtgFva07309_6").then(
      result => {
        setSpinner(false)
  ...
  return (
    <form onSubmit={sendEmail} className={styles.contact__form} ref={formRef}>
      ...
      <label className={styles.contact__checkbox}>
        <input className={styles.contact__checkbox__input} type='checkbox' onChange={toggleAcceptWithRules} />
